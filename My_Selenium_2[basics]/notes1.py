...
Alert_2 = driver.find_element(By.XPATH,'//*[@id="CancelTab"]/button')
# Alert_2.click()

#If an alert might not appear, it's worth using a try-except block
...
#moving cursor to button 'Alert with TextBox
...
#click on button to generate alert
Alert_3 = driver.find_element(By.XPATH,'//*[@id="Textbox"]/button')
...
Alert_3.send_keys(" ")
#Alert_3.send_keys(Keys.BACKSPACE)
time.sleep(time3)
